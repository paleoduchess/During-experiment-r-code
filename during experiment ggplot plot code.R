...
p.t.2 + geom_boxplot()
p.t.2 + geom_boxplot(aes(fill = Group)) + geom_jitter(cex=2)+ scale_y_continuous(name="Time (s)", limits = c(0, 600), breaks = 0:600*50) + theme_bw(18) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0" = "Expert", "1" = "Novice")) + ggtitle("Time Across All Participants") + xlab("p < 0.001")
...
p.s.2 + geom_boxplot()
p.s.2 + geom_boxplot(aes(fill = Group)) + geom_jitter(cex=2)+ scale_y_continuous(name="Strikes", limits = c(0, 1000), breaks = 0:1000*50) + theme_bw(18) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0"= "Expert", "1" = "Novice")) + ggtitle("Strikes Across All Participants") + xlab("p < 0.001")
...
p2 + ggtitle("Expert vs Novice Time") + xlab("Time (s)") + ylab("Density") + scale_x_continuous("Time (s)", lim=c(0,600), breaks=0:600*50) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0" = "Expert", "1" = "Novice")) + xlab("p < 0.001")

#Strikes
strike.density<-ggplot(data, aes(strikes, fill = Participant.group)) + geom_density(alpha = 0.2) #overlayed histograms
strike.density + ggtitle("Expert vs Novice Strikes") + xlab("Strikes") + ylab("Density") + scale_x_continuous("Strikes", lim=c(0,1000), breaks=0:1000*100) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0" = "Expert", "1" = "Novice")) + xlab("p < 0.001")
...
ggplot(data, aes(Participant, efficiency)) + geom_boxplot(aes(fill=Group)) + geom_jitter(cex=2) + ylab ("Efficiency") + theme_bw(18) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0"= "Expert", "1" = "Novice")) + ggtitle("Experts vs. Novice Efficiency") + xlab("Participants")


ggplot(data, aes(Group, efficiency)) + geom_boxplot(aes(fill=Group)) + geom_jitter(cex=2) + ylab ("Efficiency") + theme_bw(18) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0"= "Expert", "1" = "Novice")) + ggtitle("Experts vs. Novice Efficiency") + xlab("p < 0.001")
...
efficiency.density + ggtitle("Expert vs Novice Efficiency") + xlab("Efficiency") + ylab("Density") + scale_x_continuous("Efficiency", lim=c(0,10), breaks=0:10*0.5) + theme_bw(18) + scale_fill_manual(name = "Group", values = c("blue", "yellow"), labels = c("0"= "Expert", "1" = "Novice")) + ggtitle("Experts vs. Novice Efficiency") + xlab("p < 0.001")
